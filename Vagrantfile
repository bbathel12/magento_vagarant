...
Vagrant.configure("2") do |config|
 ...
 config.vm.network "private_network", ip: vagrantConfig['ip']
  ...
  #config.vm.provision "shell", inline:"sudo mount -t vboxsf -o dmode=775, fmode=664 vagrant-magento-box_ /vagrant-magento-box" 
 config.vm.provider "virtualbox" do |vb|
  ...
  config.vm.provision "shell", inline: "mkdir /root/.composer/"
